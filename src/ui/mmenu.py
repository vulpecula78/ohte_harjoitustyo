...
class Mmenu:
    ...
    def settings(self, lsetup):    
        mid = self.middle
        #Setting menu items y locations
        setting1 = self.scr_height / 4
        setting2 = self.scr_height / 4 + 50
        setting3 = self.scr_height / 4 + 100
        setting5 = self.scr_height / 4 + 220
        ...
        #center texts
        setting1_rect = soundeff.get_rect(center=(mid, setting1))
        setting2_rect = scrnsize.get_rect(center=(mid, setting2))
        setting3_rect = ai_level.get_rect(center=(mid, setting3))
        setting5_rect = back_to_main.get_rect(center=(mid, setting5))
        ...
        while True:
            ...
            for action in pygame.event.get():
                ...
                if action.type == pygame.MOUSEBUTTONDOWN:   # pylint: disable=no-member
                    if mid + 50 < mouse[0] < mid + 100 and setting1 - 20 < mouse[1] < setting1 + 20:
                        lsetup[2] = "True"
                    if mid + 130 < mouse[0] < mid + 190 and setting1 - 20 < mouse[1] < setting1 + 20:
                        lsetup[2] = "False"
                    if mid - 55 < mouse[0] < mid + 40 and setting2 -20 < mouse[1] < setting2 + 20:
                        lsetup[0] = "640"
                        lsetup[1] = "480"
                    if mid + 70 < mouse[0] < mid + 140 and setting2 -20 < mouse[1] < setting2 + 20:
                        lsetup[0] = "800"
                        lsetup[1] = "600"
                    if mid + 160 < mouse[0] < mid + 260 and setting2 -20 < mouse[1] < setting2 + 20:
                        lsetup[0] = "1024"
                        lsetup[1] = "768"
                    if mid + 15 < mouse[0] < mid + 100 and setting3 -20 < mouse[1] < setting3 + 20:
                        lsetup[3] = "easy"
                    if mid + 125 < mouse[0] < mid + 255 and setting3 -20 < mouse[1] < setting3 + 20:
                        lsetup[3] = "average"
                    if mid - 220 < mouse[0] < mid + 220 and setting5 - 20 < mouse[1] < setting5 + 20:
            ...
            if mid + 50 <= mouse[0] <= mid + 100 and setting1 - 20 <= mouse[1] <= setting1 + 20 or lsetup[2] == "True":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 50, setting1 - 20, 50, 40]) # on
            if mid + 130 <= mouse[0] <= mid + 190 and setting1 - 20 <= mouse[1] <= setting1 + 20 or lsetup[2] == "False":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 130, setting1 - 20, 60, 40]) # off
            #Screen Size
            if mid - 55 <= mouse[0] <= mid + 40 and setting2 - 20 <= mouse[1] <= setting2 + 20 or lsetup[0] == "640":
                pygame.draw.rect(self.screen, HBUTTON, [mid - 55, setting2 - 20, 95, 40])
            if mid + 70 <= mouse[0] <= mid + 140 and setting2 - 20 <= mouse[1] <= setting2 + 20 or lsetup[0] == "800":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 70, setting2 - 20, 70, 40])
            if mid + 160 <= mouse[0] <= mid + 260 and setting2 - 20 <= mouse[1] <= setting2 + 20 or lsetup[0] == "1024":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 160, setting2 - 20, 100, 40])
            #AI level
            if mid + 15 <= mouse[0] <= mid + 100 and setting3 - 20 <= mouse[1] <= setting3 + 20 or lsetup[3] == "easy":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 15, setting3 - 20, 85, 40]) # easy
            if mid + 125 <= mouse[0] <= mid + 255 and setting3 - 20 <= mouse[1] <= setting3 + 20 or lsetup[3] == "average":
                pygame.draw.rect(self.screen, HBUTTON, [mid + 125, setting3 - 20, 130, 40]) # average        
                
            #Back to main menu   
            if mid - 220 <= mouse[0] <= mid + 220 and setting5 - 20 <= mouse[1] <= setting5 + 20:
                pygame.draw.rect(self.screen, HBUTTON, [mid - 220, setting5 - 20, 440, 40])
